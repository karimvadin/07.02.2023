...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConsoleApp9.Models.Passanger", b =>
                {
            ...
            modelBuilder.Entity("ConsoleApp9.Models.Point", b =>
                {
            ...
            modelBuilder.Entity("ConsoleApp9.Models.Ticket", b =>
                {
            ...
            modelBuilder.Entity("ConsoleApp9.Models.Ticket", b =>
                {
                    b.HasOne("ConsoleApp9.Models.Passanger", "Passanger")
                        .WithMany()
                        .HasForeignKey("PassangerIdPassanger")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ConsoleApp9.Models.Point", "PointArrival")
                        .WithMany()
                        .HasForeignKey("PointArrivalIdPoint")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ConsoleApp9.Models.Point", "PointDeparture")
                        .WithMany()
